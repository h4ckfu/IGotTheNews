...
#ADDED SOURCES DAMMIT!!!!!!!!!!!!!!!!!! FOX - NBC - HUFFPO
# and then removed huffpo - i don't know why it wont honor the english requirement
sources = ['breitbart', 'infowars', 'mother_jones', 'cnn', 'abc_news', 'usatoday', 'drudge_report', 'yahoo', 'nbc_news', 'fox_news',]
